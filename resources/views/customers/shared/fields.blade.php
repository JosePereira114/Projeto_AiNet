...
<div class="flex flex-wrap space-x-8">
    <div class="grow mt-6 space-y-4">
        ...
        <x-field.input name="email" label="Email" :readonly="$readonly" value="{{ old('email', $customer->user->email) }}" />
    ...
    <div class="pb-6">
        <x-field.image name="photo_file" label="Photo" width="md" :readonly="$readonly" deleteTitle="Delete Photo" :deleteAllow="($mode == 'edit') && ($customer->user->photo_filename)" deleteForm="form_to_delete_photo" :imageUrl="$customer->user->photoFullUrl" />
    </div>
</div>