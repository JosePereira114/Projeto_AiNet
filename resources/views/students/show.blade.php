        ...
        <div class="max-full">
            <section>
                <div class="flex flex-wrap justify-end items-center gap-4 mb-4">
                    ...
                    <x-button href="{{ route('students.create') }}" text="New" type="success" />
                    @endcan
                    @can('update', $student)
                    <x-button href="{{ route('students.edit', ['student' => $student]) }}" text="Edit" type="primary" />
                    @endcan
                    @can('delete', $student)
                ...
                <x-disciplines.table :disciplines="$student->disciplines" :showView="true" :showEdit="false" :showDelete="false" :showAddToCart="true" class="pt-4" />
            </section>
        </div>
    </div>
</div>
