        ...
        <div class="max-full">
            <section>
                <div class="flex flex-wrap justify-end items-center gap-4 mb-4">
                    ...
                    @endcan
                    @can('view', $student)
                    <x-button href="{{ route('students.show', ['student' => $student]) }}" text="View" type="info" />
                    @endcan
                    @can('delete', $student)
...
<form class="hidden" id="form_to_delete_photo" method="POST" action="{{ route('students.photo.destroy', ['student' => $student]) }}">
    @csrf
    @method('DELETE')
</form>
@endsection